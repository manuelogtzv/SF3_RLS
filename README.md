...
Before running Drifter_SFs_Fluxes, datasets must be generated by running the code from Balwada et al. (2022), available here: https://github.com/dhruvbalwada/SF3_to_KEflux.git
